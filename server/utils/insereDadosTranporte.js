 ...
 *
 *
 * @description Código responsável por ler um arquivo com os dados do Transporte Escolar no formato CSV e
 ...
 * <pre>
 * ----------------------------------------------------------------------------------------------------------------------------------
 * |  ano  |  semestre  |  pp  |  aprov  |  reprov  |  nao_comp  |  total  |  p_aprov  |  p_reprov  |  p_naocomp  |  cod_municipio  |
 * ----------------------------------------------------------------------------------------------------------------------------------
 * </pre>
 * <p>
 ...
 *
 * <pre>
 * ./insereDadosTransporte.js dbhost dbuser dbpassword dbname transporte.csv
 * </pre>
 */
...
csv.fileToJSON(csvfn, function(json) {
    ...
    try {
        ...
        json.forEach(function(value) {
            arrayDeQuerys.push("INSERT INTO Transporte VALUES (NULL," +
                value.ano + "," +
                value.semestre + "," +
                "'" + value.pp + "'" + "," +
                value.aprov + "," +
